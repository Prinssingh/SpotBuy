...
public class VehiclePostManager {
    ...
    public void insert(VehiclePost vehiclePost) {
        ...
        contentValues.put(TITLE, vehiclePost.getTitle());
        contentValues.put(FUEL_TYPE, vehiclePost.getFuelType());
    ...
    public ArrayList<VehiclePost> listAll() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                vehicle.setTitle(cursor.getString(cursor.getColumnIndex(TITLE)));
                vehicle.setFuelType(cursor.getString(cursor.getColumnIndex(FUEL_TYPE)));
